<x-layout>
    <div class="bg-gray-100 flex items-center justify-center min-h-screen" >
        <form method="POST" action="/book/{{$book->id}}" class="w-full max-w-md bg-white p-6 rounded-lg shadow-md">
            @csrf
            @method('PATCH')
            <div class="flex flex-col space-y-12">
                ...
                <div class="flex items-center justify-between gap-x-6">
                    <a href="/book/{{$book->id}}" class="text-sm font-semibold leading-6 text-gray-900">Cancel</a>
